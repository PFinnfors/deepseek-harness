...
describe('dsh-base bundle', () => {
  it('declares a parseable patch list through the dsh.bundle.patch manifest field', () => {
    ...
    expect(rows.find(row => row.id === 'web')?.config).toMatchObject({ searchProvider: 'exa', fetchProvider: 'http' })
    expect(rows.find(row => row.id === 'web-search-exa')).toBeDefined()
    ...
    expect(manifest.dependencies).toHaveProperty('@deepseek-ai/dsh-web-search-exa')
  })
