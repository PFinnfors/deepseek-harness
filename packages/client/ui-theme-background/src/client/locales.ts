...
export const zh = {
  ...
  'theme.hint': 'Tokyo Night 与 Osaka Jade 无视浅色/深色/跟随系统设置；选择“无”恢复默认主题。',
...
export const en = {
  ...
  'theme.tokyoNight': 'Tokyo Night',
  'theme.osakaJade': 'Osaka Jade',
  'theme.hint': 'Tokyo Night and Osaka Jade override the light/dark/system appearance; None keeps the default theme.',
