...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-active-session': { kind: 'none', reason: 'Browser-side UI plugin layer; registers nothing model-facing.' },
  ...
  'packages/client/ui-theme-background': { kind: 'none', reason: 'Browser-side UI plugin layer; registers nothing model-facing.' },
