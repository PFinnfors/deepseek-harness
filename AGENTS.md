...
A personal, unpublished package exempts its README from bilingual pairing with one manifest exclusion line added when the package is created ([policy](docs/i18n/README.md#scope-and-exclusions)).
